...
void Inject() {
	...
	writeNearCall(0x1405bcd26, addr); // new0
	writeNearCall(0x14018967c, addr);
	writeNearCall(0x1404fc39f, addr);
	writeNearCall(0x140455099, addr);
	writeNearCall(0x140419839, addr);
	writeNearCall(0x14014be2a, addr);
	writeNearCall(0x140189448, addr);
	writeNearCall(0x142b55bbc, addr);
	writeNearCall(0x140135a37, addr);
	writeNearCall(0x1403c2033, addr);
	writeNearCall(0x140835e0d, addr);
	writeNearCall(0x1406d70fe, addr);
	writeNearCall(0x143aa520f, addr);
	writeNearCall(0x1406d708b, addr);
	writeNearCall(0x1406fe7de, addr);
	writeNearCall(0x1406fe764, addr);
	writeNearCall(0x1401fa410, addr);
	writeNearCall(0x1401ae843, addr);
	writeNearCall(0x1406ecaf2, addr);
	writeNearCall(0x1406ee2b5, addr);
	writeNearCall(0x140704f3e, addr);
	writeNearCall(0x140700254, addr);
	writeNearCall(0x1407002ce, addr);
	writeNearCall(0x1406dbc9e, addr);
	writeNearCall(0x1406e5097, addr);
	writeNearCall(0x1406e50d1, addr);
	writeNearCall(0x1406e506b, addr);
	writeNearCall(0x140704ec4, addr);
	writeNearCall(0x14070624e, addr);
	writeNearCall(0x1407061d4, addr);
	writeNearCall(0x1406dab16, addr + 0x20); // new1
	writeNearCall(0x1406dab96, addr + 0x20);
	writeNearCall(0x140206880, addr + 0x20); // gameplay speed
	writeNearCall(0x1401f83a1, addr + 0x20);
	writeNearCall(0x140159991, addr + 0x20);
	writeNearCall(0x1401ebf07, addr + 0x20);
	writeNearCall(0x140419817, addr + 0x20);
	writeNearCall(0x14018f823, addr + 0x20);
	writeNearCall(0x140158481, addr + 0x20);
	writeNearCall(0x1401517bf, addr + 0x20);
	writeNearCall(0x1401521de, addr + 0x20);
	writeNearCall(0x140158610, addr + 0x20);
	writeNearCall(0x140158795, addr + 0x20);
	writeNearCall(0x140147443, addr + 0x20);
	writeNearCall(0x14011f08f, addr + 0x20);
	writeNearCall(0x140152f94, addr + 0x20);
	writeNearCall(0x140151fb1, addr + 0x20);
	writeNearCall(0x140146177, addr + 0x20);
	writeNearCall(0x1406b8c4a, addr + 0x40); // new2
	writeNearCall(0x1401599b1, addr + 0x40); // ui
	writeNearCall(0x14047f254, addr + 0x40);
	writeNearCall(0x140506de4, addr + 0x40);
	writeNearCall(0x140506e5c, addr + 0x40);
	writeNearCall(0x1401517e6, addr + 0x40);
	writeNearCall(0x1407719e9, addr + 0x40);
	writeNearCall(0x140771e59, addr + 0x40);
	writeNearCall(0x14014746a, addr + 0x40);
	writeNearCall(0x140152206, addr + 0x40);
	writeNearCall(0x14015206e, addr + 0x40);
	writeNearCall(0x1401520d2, addr + 0x40);
	writeNearCall(0x140152fbc, addr + 0x40);
	writeNearCall(0x140153086, addr + 0x40);
	writeNearCall(0x140151fd9, addr + 0x40);
	writeNearCall(0x14014619e, addr + 0x40);
}
void RestoreInject() {
	restoreNearCall(0x1405bcd26);
	restoreNearCall(0x14018967c);
	restoreNearCall(0x1404fc39f);
	restoreNearCall(0x140455099);
	restoreNearCall(0x140419839);
	restoreNearCall(0x14014be2a);
	restoreNearCall(0x140189448);
	restoreNearCall(0x142b55bbc);
	restoreNearCall(0x140135a37);
	restoreNearCall(0x1403c2033);
	restoreNearCall(0x140835e0d);
	restoreNearCall(0x1406d70fe);
	restoreNearCall(0x143aa520f);
	restoreNearCall(0x1406d708b);
	restoreNearCall(0x1406fe7de);
	restoreNearCall(0x1406fe764);
	restoreNearCall(0x1401fa410);
	restoreNearCall(0x1401ae843);
	restoreNearCall(0x1406ecaf2);
	restoreNearCall(0x1406ee2b5);
	restoreNearCall(0x140704f3e);
	restoreNearCall(0x140700254);
	restoreNearCall(0x1407002ce);
	restoreNearCall(0x1406dbc9e);
	restoreNearCall(0x1406e5097);
	restoreNearCall(0x1406e50d1);
	restoreNearCall(0x1406e506b);
	restoreNearCall(0x140704ec4);
	restoreNearCall(0x14070624e);
	restoreNearCall(0x1407061d4);
	restoreNearCall(0x1406dab16);
	restoreNearCall(0x1406dab96);
	restoreNearCall(0x140206880);
	restoreNearCall(0x1401f83a1);
	restoreNearCall(0x140159991);
	restoreNearCall(0x1401ebf07);
	restoreNearCall(0x140419817);
	restoreNearCall(0x14018f823);
	restoreNearCall(0x140158481);
	restoreNearCall(0x1401517bf);
	restoreNearCall(0x1401521de);
	restoreNearCall(0x140158610);
	restoreNearCall(0x140158795);
	restoreNearCall(0x140147443);
	restoreNearCall(0x14011f08f);
	restoreNearCall(0x140152f94);
	restoreNearCall(0x140151fb1);
	restoreNearCall(0x140146177);
	restoreNearCall(0x1406b8c4a);
	restoreNearCall(0x1401599b1);
	restoreNearCall(0x14047f254);
	restoreNearCall(0x140506de4);
	restoreNearCall(0x140506e5c);
	restoreNearCall(0x1401517e6);
	restoreNearCall(0x1407719e9);
	restoreNearCall(0x140771e59);
	restoreNearCall(0x14014746a);
	restoreNearCall(0x140152206);
	restoreNearCall(0x14015206e);
	restoreNearCall(0x1401520d2);
	restoreNearCall(0x140152fbc);
	restoreNearCall(0x140153086);
	restoreNearCall(0x140151fd9);
	restoreNearCall(0x14014619e);
}
#pragma endregion
